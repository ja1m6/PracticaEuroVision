...
CREATE TABLE RESULTADOS_COMUNIDAD (
	ID_RESULTADO_COMUNIDAD INT AUTO_INCREMENT COMMENT "",
	NOMBRE_COMUNIDAD VARCHAR(50) NOT NULL COMMENT '',
    NUMERO_VOTOS_COMUNIDAD INT COMMENT '',
    DNI_ARTISTA VARCHAR(9) COMMENT '',
    
    CONSTRAINT PK_RESULTADOS_COMUNIDAD PRIMARY KEY (ID_RESULTADO_COMUNIDAD),
...
CREATE TABLE RESULTADOS_EDAD (
	ID_RESULTADO_EDAD INT AUTO_INCREMENT COMMENT "",
	RANGO VARCHAR(30) NOT NULL COMMENT '',
    NUMERO_VOTOS_EDAD INT COMMENT '',
    DNI_ARTISTA VARCHAR(9) COMMENT '',
    
    CONSTRAINT PK_RESULTADOS_EDAD PRIMARY KEY (ID_RESULTADO_EDAD),
