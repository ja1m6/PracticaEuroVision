...
public class Controlador implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==inicio.letraazul) {
			...
			inicio.lbt1.setForeground(Color.blue);
			inicio.lbt2.setForeground(Color.blue);
		...
		if(e.getSource()==inicio.letrarojo) {
			...
			inicio.lbt1.setForeground(Color.red);
			inicio.lbt2.setForeground(Color.red);
			inicio.lbt3.setForeground(Color.red);
			inicio.lbmodt.setForeground(Color.red);
			...
			inicio.bsciu.setForeground(Color.red);
			inicio.bstol.setForeground(Color.red);
			inicio.bscue.setForeground(Color.red);
			inicio.bsalb.setForeground(Color.red);
		...
		if(e.getSource()==inicio.nuevoletra) {
			...
			inicio.lbt1.setForeground(nuevocolor);
			inicio.lbt2.setForeground(nuevocolor);
		...
		if(e.getSource()==inicio.btcomprobarpersonalizacion) {
			...
			//Mostrar Color
			if(codigocolor.contains(inicio.colordigito3.getText())&&codigocolor.contains(inicio.colordigito2.getText())&&codigocolor.contains(inicio.colordigito1.getText())) {
